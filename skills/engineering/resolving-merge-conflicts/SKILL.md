...
description: Resolve an in-progress git merge or rebase conflict. Use when you need to resolve a merge or rebase conflict, or the user reports a conflict during a merge or rebase.
---
