...
`MISSION.md` lives at the workspace root. It captures the *reason* the user
is learning this topic. Every teaching decision (what to teach next, which
...
- **Revise when reality shifts.** Missions change. When the user's goal
  moves, update this file; don't leave a stale mission steering future
  sessions.
- **Keep it short.** If `MISSION.md` runs past a screen, it has stopped
