...
the provider-correct git-host command snippets (`forge <key>`, detecting GitHub
vs Forgejo/Gitea from `origin`). See [references/artifacts.md](plugins/prd-workflow/references/artifacts.md)
for the schema.
